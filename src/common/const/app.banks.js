// 20230712132809
// https://api.vietqr.io/v2/banks?fbclid=IwAR1XGtlr3HqY7bfxbH5UnSaHcroE81o15C-wEnlEaTS0ZnuVvuDaLQ8TnWU
...
const listBankMap = new Map();

listBank.forEach((item) => {
	listBankMap.set(item.bin, item);
});

module.exports = listBankMap;
